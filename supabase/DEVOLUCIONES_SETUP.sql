...
-- 0. CREAR TABLA ordenes si no existe
-- (Tabla para nuevos pedidos con Stripe)
...
-- Crear tabla items_orden si no existe
...
-- Crear índices para items_orden
...
-- 4. Habilitar RLS en devoluciones
ALTER TABLE devoluciones ENABLE ROW LEVEL SECURITY;

-- Políticas RLS para devoluciones
...
-- 5. Función para buscar devolución por email y número
...
-- 7. Trigger para actualizar fecha de modificación
...
COMMENT ON TABLE devoluciones IS 'Solicitudes de devolución de pedidos';
COMMENT ON COLUMN devoluciones.estado IS 'Pendiente: esperando revisión, Aprobada: aceptada, Rechazada: denegada, Producto_Recibido: producto devuelto, Reembolso_Procesado: dinero devuelto, Completada: proceso finalizado';
