...
export default function StripePayment({ 
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      const expireDate = new Date(2000 + parseInt(year || '00'), parseInt(month || '01'));
      ...
      <form onSubmit={handleSubmit as any} className="space-y-4">
        ...
        <div>
          ...
          <input
            ...
            onChange={(e: any) => setCardholderName((e.target as HTMLInputElement).value)}
        ...
        <div className="grid grid-cols-2 gap-4">
          <div>
            ...
            <input
              type="text"
              value={expiry}
              onChange={handleExpiryChange as any}
          ...
          <div>
            ...
            <input
              type="text"
              value={cvc}
              onChange={handleCvcChange as any}
              placeholder="Ej: 123"
              maxLength={4}
              className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#00aa45] focus:border-transparent font-mono"
              required
